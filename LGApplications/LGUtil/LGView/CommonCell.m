...
- (void)setUpSubviews{
    ...
    CGFloat titleW = [self.title sizeWithAttributes:@{NSFontAttributeName:kFontWithSize(14)}].width+1;
...
- (void)setTitle:(NSString *)title{
    CGFloat titleW = [title sizeWithAttributes:@{NSFontAttributeName:kFontWithSize(14)}].width+1;
    _title = title;
