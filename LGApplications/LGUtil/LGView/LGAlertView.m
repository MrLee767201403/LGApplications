...
- (void)setUpSubViews{
    ...
    CGFloat height = [_content boundingRectWithSize:CGSizeMake(kScreenWidth-134, MAXFLOAT) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:kFontWithSize(16)} context:nil].size.height+1;
    ...
    _contentLabel.font = kFontWithSize(14);
    ...
    _noButton.titleLabel.font = kFontWithSize(16);
    ...
    _okButton.titleLabel.font = kFontWithSize(16);
