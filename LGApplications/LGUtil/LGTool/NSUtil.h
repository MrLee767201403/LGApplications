...
+ (void)performBlockOnMainThread:(ActionBlock)block;
...
/**  Document下文件夹路径 没有时会创建一个*/
+ (NSString *)getDocumentDirectory:(NSString *)directory;

/**  Document下文件路径*/
+ (NSString *)getDocumentFileWithDirectory:(NSString *)directory filePath:(NSString *)file;
