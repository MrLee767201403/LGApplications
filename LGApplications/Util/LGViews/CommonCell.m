...
@property (nonatomic, strong) UIImageView *checkView;   // 对勾
...
- (void)setUpSubviews{
    ...
    [self setBackgroundColor:kColorBackground forState:UIControlStateHighlighted];
    ...
    self.detailView.textColor = kColorText;
    ...
    self.checkView = [[UIImageView alloc] initWithFrame:CGRectMake(75, 10, 15, 15)];
    self.checkView.image = Image(@"icon_check");
    self.checkView.hidden = YES;
    self.checkView.contentMode = UIViewContentModeCenter;
    ...
    [self.detailView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.checkView);
